...
public class BlendokuBonusLevel extends BlendokuLevel {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.activity_blendoku_bonus_level);
        // Set layout variables.
        numOfColor = 4;
        randomColor = new RandomColorBonus();
        ...
        TextView bonusLevel = findViewById(R.id.TVbonuslevel);
        bonusLevel.setText("Wow, you've unlocked a bonus level!");
        views.add(color1);
        views.add(color2);
        views.add(color3);
        views.add(color4);
        ...
        CountDownTimer countDownTimer = new CountDownTimer(user.getTimer(1), 1000) {
            ...
            public void onFinish() {
                ...
                updateObjectManager();
                Intent intent = new Intent(BlendokuBonusLevel.this, TimesUp.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BlendokuBonusLevel.this, Game1Activity.class);
                intent.putExtra("gameManager", gameManager);
                intent.putExtra("filePath", filepath);
                startActivity(intent);
            }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updateObjectManager();
                //Show the scoreboard.
                Intent intent = new Intent(BlendokuBonusLevel.this, ScoreBoardActivity.class);
