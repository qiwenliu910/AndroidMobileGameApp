...
public class BlendokuLevel1 extends BlendokuLevel {
  @Override
  protected void onCreate(Bundle savedInstanceState) {
    setContentView(R.layout.activity_blendoku_level1);
    numOfColor = 3;
      ...
      CountDownTimer countDownTimer =
              new CountDownTimer(user.getTimer(1), 1000) {
                  ...
                  public void onFinish() {
                      ...
                      updateObjectManager();
                      Intent intent = new Intent(BlendokuLevel1.this, TimesUp.class);
      ...
      back.setOnClickListener(
              new View.OnClickListener() {
                  ...
                  public void onClick(View v) {
                      ...
                      Intent intent = new Intent(BlendokuLevel1.this, Game1Activity.class);
                      intent.putExtra("gameManager", gameManager);
                      intent.putExtra("filePath", filepath);
                      startActivity(intent);
                  }
      ...
      next.setOnClickListener(
              new View.OnClickListener() {
                  ...
                  public void onClick(View v) {
                      ...
                      updateObjectManager();
                      // Unlock level2.
                      Intent intent = new Intent(BlendokuLevel1.this, BlendokuLevel2.class);
